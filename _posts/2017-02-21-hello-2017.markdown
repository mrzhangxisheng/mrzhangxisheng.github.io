...
在网络上见识到了各种大神，激动的心情久久不能平复，大神们都有自己的个人博客。虽然没有大神的技术，但是也想追随大神的脚步。

另外也是想找一个更自由的地方来记录一些技术和生活相关的东西，于是这个 Blog 就这么出现了。

下面的正文和后记是这个主题原作者的记录，后续我也会把我自己的搭建过程记录下来覆盖掉原作者的内容。就先留着吧。
